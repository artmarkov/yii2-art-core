...
class MultilingualUrlManager extends UrlManager
{
    ...
    public function createUrl($params)
    {
        ...
        if (Yii::$app->art->isMultilingual && !empty($this->multilingualRules)) {
            ...
            if (!isset($params['language'])) {
                ...
                $params['language'] = Yii::$app->art->getDisplayLanguageShortcode(Yii::$app->language);
            }
        }
    ...
    {
        $rules = $this->rules;
        $prefix = Yii::$app->art->isMultilingual ? $this->languagePattern . '/' : '';
