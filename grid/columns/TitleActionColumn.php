...
class TitleActionColumn extends \yii\grid\DataColumn
{
    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                $options = array_merge([
                    ...
                    'aria-label' => Yii::t('art', 'View'),
                    'data-pjax' => '0',
                ], $this->buttonOptions);
                return Html::a(Yii::t('art', 'View'), $url, $options);
            };
        }
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                $options = array_merge([
                    ...
                    'aria-label' => Yii::t('art', 'Edit'),
                    'data-pjax' => '0',
                ], $this->buttonOptions);
                return Html::a(Yii::t('art', 'Edit'), $url, $options);
            };
        }
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                ...
                return Html::a(Yii::t('art', 'Delete'), $url, $options);
            };
        }
    }
     ...
     * @param \artsoft\db\ActiveRecord $model the data model
